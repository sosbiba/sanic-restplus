...
project = u'Sanic-RESTPlus'
copyright = u'2017, Ashley Sommer'
...
release = __import__('sanic_restplus').__version__
# The short X.Y version.
version = '.'.join(release.split('.')[:1])

# Github repo
issues_github_path = 'ashleysommer/sanic-restplus'
...
htmlhelp_basename = 'Sanic-RESTPlusdoc'
...
latex_documents = [
  ('index', 'Sanic-RESTPlus.tex', u'Sanic-RESTPlus Documentation',
...
man_pages = [
    ('index', 'Sanic-restplus', u'Sanic-RESTPlus Documentation',
     [u'Axel Haustant'], 1)
]
...
texinfo_documents = [
  ('index', 'Sanic-RESTPlus', u'Sanic-RESTPlus Documentation',
   u'Axel Haustant', 'Sanic-RESTPlus', 'One line description of project.',
   'Miscellaneous'),
]
